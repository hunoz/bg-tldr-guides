...
/**
 * Unit tests for game ID derivation from the actual i18n namespace list.
 * Verifies that the exported gameIds correctly excludes 'common'.
 */
describe('gameIds export from i18n service', () => {
   
  const { gameIds, ns } = require('../i18n/index');
