      ...
      {items.map((item, i) => (
        ...
        >
          <View style={styles.buildingHeader}>
            ...
            <Text style={[styles.buildingName, { color: theme.colors.text, fontFamily: theme.fonts.heading }]}>
              {item.name}
            </Text>
          </View>
          <Text style={[styles.buildingEffect, { color: theme.colors.text, fontFamily: theme.fonts.body }]}>
            {item.effect}
          </Text>
        </View>
      ))}
