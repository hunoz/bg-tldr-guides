      ...
      {tiles.map((tile, i) => (
        ...
        >
          <View style={styles.tileHeader}>
            <View style={[styles.dot, { backgroundColor: dotColors[tile.dotClass] ?? theme.colors.accent }]} />
            <Text style={[styles.tileColor, { color: theme.colors.textMuted, fontFamily: theme.fonts.body }]}>
              {tile.color}
            </Text>
            <Text style={[styles.tileType, { color: theme.colors.text, fontFamily: theme.fonts.heading }]}>
              {tile.type}
            </Text>
          </View>
          <Text style={[styles.tileDesc, { color: theme.colors.text, fontFamily: theme.fonts.body }]}>
            {tile.desc}
          </Text>
        </View>
      ))}
