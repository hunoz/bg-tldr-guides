...
const scoringRows = [
    {
        outcomeKey: 'endOfRound.scoring.didntExplode',
        rewardKey: 'endOfRound.scoring.didntExplodeReward',
    },
...
const rubyRows = [
    {
        actionKey: 'endOfRound.spendRubies.refillFlask',
        effectKey: 'endOfRound.spendRubies.refillFlaskEffect',
    },
    {
        actionKey: 'endOfRound.spendRubies.advanceDroplet',
        effectKey: 'endOfRound.spendRubies.advanceDropletEffect',
    },
];

const ratStepKeys = ['endOfRound.rats.step1', 'endOfRound.rats.step2', 'endOfRound.rats.step3'];
        ...
        <View>
            ...
            <View style={[styles.parchmentCard, { backgroundColor: parchmentBg }]}>
                ...
                <View style={styles.rewardsRow}>
                    {rewardKeys.map((key, i) => (
                        <View
                            key={i}
                            style={[styles.rewardChip, { backgroundColor: theme.colors.card }]}
                        >
                            <RichText
                                value={t(key)}
                                style={{
            ...
            <View style={[styles.parchmentCard, { backgroundColor: parchmentBg }]}>
                ...
                {scoringRows.map((row, i) => (
                    ...
                    >
                        <Text style={[styles.tableCellBody, { color: darkText }]}>
                            {t(row.outcomeKey)}
                        </Text>
                        <RichText
            ...
            <View style={[styles.parchmentCard, { backgroundColor: parchmentBg }]}>
                ...
                {ratStepKeys.map((key, i) => (
                    <View key={i} style={styles.listItem}>
                        <Text style={[styles.ordinal, { color: theme.colors.accent }]}>
                            {i + 1}.
                        </Text>
