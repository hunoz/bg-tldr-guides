...
export function Overview() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.cardAlt ?? theme.colors.card, borderColor: theme.colors.border ?? '#4a2d6e' }]}>
      <View style={styles.statsRow}>
        {stats.map((stat) => (
          ...
          >
            ...
            <Text style={[styles.statValue, { color: theme.colors.accent, fontFamily: theme.fonts.heading }]}>
              {stat.valueKey.startsWith('overview.') ? t(stat.valueKey) : stat.valueKey}
            </Text>
          </View>
        ))}
      </View>
