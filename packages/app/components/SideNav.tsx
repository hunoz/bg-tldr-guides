...
export function SideNav() {
    ...
    // currentLocale triggers re-sort when the user switches languages
    ...
    return (
        <>
            ...
            <Pressable
                ...
                style={[styles.toggleButton, { backgroundColor: theme.colors.card + 'DD' }]}
                accessibilityRole='button'
                accessibilityLabel='Toggle navigation menu'
            >
                <Text style={[styles.toggleIcon, { color: theme.colors.text }]}>☰</Text>
            </Pressable>
            ...
            >
                ...
                >
                        ...
                        <View style={styles.languageRow}>
                            ...
                            >
                                <Text style={[styles.languageText, { color: theme.colors.text }]}>
                                    ...
                                    {LOCALE_META[currentLocale]?.label ?? currentLocale} ▾
                                </Text>
                            </Pressable>
                        </View>
                    ...
                    {/* Home button — only shown on game pages */}
                    {currentGameId && (
                        <Pressable
                            onPress={() => {
                                router.push('/');
                ...
                <View style={[styles.footer, { borderTopColor: theme.colors.textMuted + '30' }]}>
